 ...
 *         2. Nguyen Khac Hoang
 *         3. Nguyen Truong Duy
 * Day created: 07.01.2022
 * Last update: 10.02.2023
 * Description: Create Rook Curve(space filling) using iteration method
 *
 * Function: press
...
public class TheRookCurve extends PApplet{
    int level =1; // number of Iteration
    ...
    public void setup(){
        ...
        surface.setTitle("The Rook Curve!"); // name of the window
   ...
   /* public static void main(String[] args) {
        String[] name = new String[] {"TheRookCurve"};
        PApplet.main(name);
    } */
}
